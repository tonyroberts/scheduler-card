...
`;var qa="M19,6.41L17.59,5L12,10.59L6.41,5L5,6.41L10.59,12L5,17.59L6.41,19L12,13.41L17.59,19L19,17.59L13.41,12L19,6.41Z",Va="M20.71,7.04C21.1,6.65 21.1,6 20.71,5.63L18.37,3.29C18,2.9 17.35,2.9 16.96,3.29L15.12,5.12L18.87,8.87M3,17.25V21H6.75L17.81,9.93L14.06,6.18L3,17.25Z";const Ra={alarm_control_panel:"domains.alarm_control_panel",automation:"ui.dialogs.quick-bar.commands.navigation.automation",binary_sensor:"domains.binary_sensor",calendar:"panel.calendar",climate:"domains.climate",cover:"domains.cover",fan:"domains.fan",group:"domains.group",humidifier:"domains.humidifier",input_boolean:"domains.input_boolean",input_number:"domains.input_number",input_select:"domains.input_select",lawn_mower:"domains.lawn_mower",light:"domains.light",lock:"domains.lock",media_player:"domains.media_player",notify:"domains.notify",person:"ui.dialogs.quick-bar.commands.navigation.person",scene:"ui.dialogs.quick-bar.commands.navigation.scene",script:"ui.dialogs.quick-bar.commands.navigation.script",sensor:"ui.panel.config.devices.entities.sensor",sun:"ui.panel.config.automation.editor.conditions.type.sun.label",switch:"domains.switch",vacuum:"domains.vacuum",water_heater:"domains.water_heater"},Ua=(e,t)=>{if(e in Ra){const i=Ra[e],s=i.startsWith("domains")?Zs(i,ot(t)):t.localize(i);if(s)return s}return e};function Ha(e,t,i){let s=[];t.groups&&t.groups.forEach(t=>{e.find(e=>va(e,t))&&(s=[...s,{name:t.name,icon:t.icon||"folder-outline",entities:e.filter(e=>va(e,t))}])});const a=e.filter(e=>!s.some(t=>t.entities.includes(e)));return a.map(De).filter((e,t,i)=>i.indexOf(e)===t).forEach(e=>{s=[...s,{name:Ua(e,i),icon:(void 0===t.standard_configuration||t.standard_configuration)&&e in lt?lt[e]:"folder-outline",entities:a.filter(t=>va(t,{include:[e],exclude:[]}))}]}),s}const Ba={options:["on","off"]},Fa={alarm_control_panel:{template:e=>{let t=["disarmed","triggered"];const i=Et(e,"supported_features")||0;return 2&i&&(t=[...t,"armed_away"]),1&i&&(t=[...t,"armed_home"]),4&i&&(t=[...t,"armed_night"]),16&i&&(t=[...t,"armed_custom_bypass"]),32&i&&(t=[...t,"armed_vacation"]),{options:t}}},binary_sensor:Ba,climate:{options:"hvac_modes"},calendar:Ba,cover:{options:["open","closed"]},device_tracker:{options:["home","not_home"]},fan:Ba,humidifier:Ba,input_boolean:Ba,input_number:{min:"min",max:"max",unit:"unit_of_measurement",step:"step"},input_select:{options:"options"},light:Ba,lock:{options:["locked","unlocked"]},number:{min:"min",max:"max",step:"step"},person:{template:(e,t)=>{const i=Object.keys(t.states).filter(e=>"zone"==De(e)).map(Ne);return{options:[...new Set(["home","not_home",...i])]}}},proximity:{unit:"unit_of_measurement"},select:{options:"options"},sensor:{template:e=>e&&!isNaN(Number(e.state))?"%"==Ct(e,"unit_of_measurement")?{min:0,max:100,unit:"%",step:1}:{unit:"unit_of_measurement"}:{}},sun:{options:["below_horizon","above_horizon"]},switch:Ba,timer:{options:["active","paused","idle"]},water_heater:{options:"operation_list"}},Za=(e,t)=>Re(Object.assign(Object.assign({},e),{state:t})),Ya=(e,t)=>{const i="closed"==t;switch(e.attributes.device_class){case"garage":return i?"mdi:garage":"mdi:garage-open";case"door":return i?"mdi:door-closed":"mdi:door-open";case"blind":return i?"mdi:blinds":"mdi:blinds-open";case"window":return i?"mdi:window-closed":"mdi:window-open";default:return i?"mdi:window-shutter":"mdi:window-shutter-open"}},Wa={alarm_control_panel:{disarmed:"mdi:lock-open-variant-outline",armed_away:"mdi:exit-run",armed_home:"mdi:home-outline",armed_night:"mdi:power-sleep",triggered:"mdi:alarm-light-outline"},binary_sensor:{on:Za,off:Za},calendar:{on:"mdi:flash",off:"mdi:flash-off"},climate:{off:"mdi:power-off",heat:"mdi:fire",cool:"mdi:snowflake",heat_cool:"mdi:thermometer",auto:"mdi:autorenew",dry:"mdi:water-percent",fan_only:"mdi:fan"},cover:{closed:Ya,open:Ya},device_tracker:{home:"mdi:home-outline",not_home:"mdi:exit-run"},fan:{on:"mdi:power",off:"mdi:power-off"},humidifier:{on:"mdi:power",off:"mdi:power-off"},input_boolean:{on:"mdi:flash",off:"mdi:flash-off"},light:{on:"mdi:lightbulb",off:"mdi:lightbulb-off"},lock:{unlocked:"mdi:lock-open-variant-outline",locked:"mdi:lock-outline"},person:(e,t,i)=>{const s={home:"mdi:home-outline",not_home:"mdi:exit-run"};return Object.keys(i.states).filter(e=>"zone"==De(e)).forEach(e=>{const t=Ne(e),a=i.states[e].attributes.icon;a&&(s[t]=a)}),t in s?s[t]:"mdi:flash"},sensor:{unit:"attributes.unit_of_measurement"},sun:{below_horizon:"mdi:weather-sunny-off",above_horizon:"mdi:weather-sunny"},switch:{on:"mdi:flash",off:"mdi:flash-off"},timer:{active:"mdi:play",paused:"mdi:pause",idle:"mdi:sleep"}},Ga=(e,t,i,s)=>{const a=De(e.entity_id);if(t||(t=e.state),a in Wa){if(t in Wa[a]){const s=Wa[a][t];return"string"==typeof s?s:s(e,t,i)}if("function"==typeof Wa[a])return Wa[a](e,t,i)}return s||"folder-outline"};function Ka(e,t){const i=De(e),s=t.states[e];if(!s)return null;if("group"==i){const i=t.states[e],s=At(i,"entity_id");if(!s.length)return null;const o=s.map(e=>Ka(e,t));return o.every(Xe)?(a=o).length&&a.every(e=>e.type==a[0].type)?a[0].type==xt.List?Bt(...a):a[0].type==xt.Level?Nt(...a):null:null:null}var a;if(!Object.keys(Fa).includes(i))return null;let o=Mt(Fa[i],s,t);if("options"in o&&Xe(o.options)){let e=[...o.options];return e=e.map(e=>Object.assign(e,{icon:e.icon?e.icon:Ga(s,e.value,t,"flash"),name:e.name?e.name:Ja(s,e.value,t)})),o=Object.assign(Object.assign({},o),{options:e}),e.length?Bt(o):null}return"min"in o&&Xe(o.min)&&"max"in o&&Xe(o.max)?Nt(o):Zt(o)}const Ja=(e,t,i)=>{const s=De(e.entity_id);return e.attributes.device_class&&i.localize(`component.${s}.entity_component._.${e.attributes.device_class}.state.${t}`)||i.localize(`component.${s}.entity_component._.state.${t}`)||t};function Xa(e,t,i){let s=i.standard_configuration?Ka(e,t):null;const a=Object.entries(i.customize).filter(([t])=>ct(t,e)).sort((e,t)=>t[0].length-e[0].length).map(([,e])=>e.states).filter(Xe);return a.length&&a.forEach(e=>{s=Array.isArray(e)?Bt({options:e.map(e=>Object({value:e}))}):Nt(e)}),s}function Qa(e,t,i={filterActions:!0,filterStates:!1}){let s=Object.keys(e.states).filter(e=>va(e,t));return"notify"in e.services&&(s=[...s,...Object.keys(e.services.notify).map(e=>"notify."+e).filter(e=>va(e,t))]),i.filterActions&&i.filterStates?s=s.filter(i=>pa(i,e,t).length||Xa(i,e,t)):i.filterActions?s=s.filter(i=>pa(i,e,t).length):i.filterStates&&(s=s.filter(i=>Xa(i,e,t))),s}const eo=(e,t)=>{let i={entity_id:e,service:t.service,service_data:Object.assign({},t.service_data)};return Object.entries(t.variables||{}).forEach(([e,t])=>{Object.keys(i.service_data||{}).includes(e)||(t.type==xt.Level?(t=t,i=Object.assign(Object.assign({},i),{service_data:t.optional?Ge(i.service_data||{},e):Object.assign(Object.assign({},i.service_data),{[e]:parseFloat((t.min*t.scale_factor).toPrecision(12))||0})})):t.type==xt.List?(t=t,i=Object.assign(Object.assign({},i),{service_data:Object.assign(Object.assign({},i.service_data),{[e]:t.options.length?t.options[0].value:void 0})})):t.type==xt.Text&&(t=t,i=Object.assign(Object.assign({},i),{service_data:Object.assign(Object.assign({},i.service_data),{[e]:""})})))}),i},to=(e,t,i,s)=>{if(!e)return null;const a=_a(e,s);let o=i.find(e=>aa(e,a,!0));if(!o)return null;let n=t.map(e=>eo(e,o));return n=Object.keys(o.variables||{}).filter(t=>Object.keys(e.service_data||{}).includes(t)).reduce((t,i)=>{if(!t)return t;switch(o.variables[i].type){case xt.Level:const s=o.variables[i];let a=Number(e.service_data[i]);return a/=s.scale_factor,a=Math.round(a/s.step)*s.step,a=parseFloat(a.toPrecision(12)),a>s.max?a=s.max:a<s.min&&(a=s.min),a*=s.scale_factor,a=parseFloat(a.toFixed(2)),t.map(e=>Object.assign(e,{service_data:Object.assign(Object.assign({},e.service_data),{[i]:a})}));case xt.List:return o.variables[i].options.some(t=>t.value==e.service_data[i])?t.map(t=>Object.assign(t,{service_data:Object.assign(Object.assign({},t.service_data),{[i]:e.service_data[i]})})):null;case xt.Text:return t.map(t=>Object.assign(t,{service_data:Object.assign(Object.assign({},t.service_data),{[i]:e.service_data[i]})}));default:return t}},n),n};function io(e,t){return e.id||e.value||t}let so=class extends ae{constructor(){super(...arguments),this.items=[],this.value=null}render(){return this.items.length?this.items.map((e,t)=>this.renderButton(e,t)):I`
        <div class="text-field">
          <slot></slot>
        </div>
      `}renderButton(e,t){const i=Array.isArray(this.value)?this.value:[this.value],s=io(e,t);return I`
      <mwc-button
    ...
    `}};t([le({attribute:!1})],ao.prototype,"hass",void 0),t([de()],ao.prototype,"_params",void 0),ao=t([ne("generic-dialog")],ao);var oo=Object.freeze({__proto__:null,get GenericDialog(){return ao}});const no=[{start:"00:00:00",stop:"08:00:00",actions:[]},{start:"08:00:00",stop:"16:00:00",actions:[]},{start:"16:00:00",stop:"00:00:00",actions:[]}];let ro=class extends ae{constructor(){super(...arguments),this.entities=[],this.multipleEntity=!1,this.scheduleEntities=[],this.timeSchemeSelected=!1,this.editItem=!1}provideHass(e){e.hass=this.hass}async firstUpdated(){if(this.scheduleEntities=(await vt(this.hass)).map(e=>e.entity_id),this.entities&&this.entities.length){const e=this.getGroups().find(e=>e.entities.find(e=>e==this.entities[0]));if(!e)return;this.selectedGroup=e,this.multipleEntity=this.entities.length>1}if(this.schedule)if(this.schedule.timeslots.every(e=>e.stop))this.timeSchemeSelected=!0;else{const e=Je(Ke(this.schedule.timeslots.map(e=>e.actions))),t=this.getActionsForEntity().filter(t=>e.some(e=>aa(e,t,!0)));1==t.length&&(this.selectedAction=t[0])}}getGroups(){if(!this.hass||!this.config)return[];const e=Ha(Qa(this.hass,this.config).filter(e=>"switch"!==De(e)||!this.scheduleEntities.includes(e)),this.config,this.hass);return e.sort(et),e}getEntitiesForGroup(){if(!this.selectedGroup||!this.hass||!this.config)return[];const e=this.selectedGroup.entities.map(e=>ut(e,this.hass,this.config));return e.sort(et),e}getActionsForEntity(e){if(e||(e=this.entities),!this.hass||!this.config||!e.length)return[];const t=pa(e,this.hass,this.config).map(e=>Object.assign(e,{name:ha(e)}));return t.sort(et),t}render(){var e;if(!this.hass||!this.config)return I``;const t=this.getGroups();1!=t.length||Qe(this.selectedGroup,t[0])||this.selectGroup(t[0]);const i=this.getEntitiesForGroup();1==i.length&&this.entities[0]!==i[0].id&&this.selectEntity(i[0].id);const s=this.getActionsForEntity();return I`
      <div class="content">
        ...
        >
          ${Zs("ui.panel.entity_picker.no_groups_defined",ot(this.hass))}
        </sc-button-group>
        ...
        <div class="header">
          ...
          ${i.length>1?I`
                <div class="switch">
                  ...
                  ${Zs("ui.panel.entity_picker.multiple",ot(this.hass))}
                </div>
              `:""}
        </div>
        <sc-button-group
          ...
          id="selectedEntity"
        >
          ${this.selectedGroup?Zs("ui.panel.entity_picker.no_entities_for_group",ot(this.hass)):Zs("ui.panel.entity_picker.no_group_selected",ot(this.hass))}
        </sc-button-group>
        ...
        <sc-button-group
          ...
          id="selectedAction"
        >
          ${this.entities.length?Zs("ui.panel.entity_picker.no_actions_for_entity",ot(this.hass)):Zs("ui.panel.entity_picker.no_entity_selected",ot(this.hass))}
        </sc-button-group>
    ...
    `}makeSchemeButton(e){return e.length&&this.hass?I`
      ...
      <div class="option-list">
        <mwc-button
          ...
          ${Zs("ui.panel.entity_picker.make_scheme",ot(this.hass))}
        </mwc-button>
      </div>
    </div>
    `:I``}selectGroup(e){this.selectedGroup=e,this.entities=[],this.selectedAction=void 0}async selectEntity(e){const t=nt("object"==typeof e?e.target.value:e);let i=this.selectedAction;if(i){let e=this.getActionsForEntity(t);this.entities.every(e=>"script"==De(e))&&this.entities.includes(i.service)?(i=Object.assign(Object.assign({},i),{service:"script.script"}),e=e.map(e=>t.includes(e.service)?Object.assign(Object.assign({},e),{service:"script.script"}):e),i=e.find(e=>aa(e,i)),i=Object.assign(Object.assign({},i),{service:t[0]})):i=e.find(e=>aa(e,i))}else i=void 0;if(this.schedule&&t.length&&(this.timeSchemeSelected||this.selectedAction)){const s=await this.migrateSchedule(t,this.timeSchemeSelected?null:i);if(!s)return this.selectedAction=null,"object"==typeof e&&e.stopPropagation(),void(this.shadowRoot.querySelector("#selectedEntity").value=this.entities);this.entities=t,this.selectedAction=i,this.dispatchEvent(new CustomEvent("change",{detail:s}))}else this.entities=t,this.selectedAction=i}async selectAction(e){const t=e.detail;if(this.schedule){const i=await this.migrateSchedule(this.entities,t);if(!i)return this.selectedAction=null,e.stopPropagation(),void(this.shadowRoot.querySelector("#selectedAction").value=null);this.dispatchEvent(new CustomEvent("change",{detail:i}))}this.selectedAction=t,this.timeSchemeSelected=!1}async selectTimeScheme(e){if(this.schedule){const t=await this.migrateSchedule(this.entities,null);if(!t)return void e.stopPropagation();this.dispatchEvent(new CustomEvent("change",{detail:t}))}this.selectedAction=null,this.timeSchemeSelected=!0}nextClick(){if(!this.hass||!this.config||!this.selectedAction&&!this.timeSchemeSelected)return;const e=1==nt(this.config.tags).length?nt(this.config.tags).slice(0,1):[];if(this.timeSchemeSelected)this.actions=pa(this.entities,this.hass,this.config),this.schedule={weekdays:["daily"],timeslots:no,repeat_type:wt.Repeat,tags:e};else{let t=Be(wa(new Date,ot(this.hass),Te.twenty_four),this.hass);t=Ze(t,this.config.time_step,{wrapAround:!0}),this.actions=[this.selectedAction];const i={start:Fe(t),actions:this.entities.map(e=>eo(e,this.actions[0]))};this.schedule={weekdays:["daily"],timeslots:[i],repeat_type:wt.Repeat,tags:e}}this.dispatchEvent(new CustomEvent("change",{detail:{schedule:this.schedule,entities:this.entities.map(e=>ut(e,this.hass,this.config)),actions:this.actions,tab:Ue.Time}}))}migrateSchedule(e,t){let i=!0,s=function e(t){return null==t?t:t instanceof Array?t.reduce((t,i,s)=>(t[s]=e(i),t),[]):t instanceof Object?Object.keys(t).reduce((i,s)=>(i[s]=e(t[s]),i),{}):t}(this.schedule);const a=null!==t?[t]:pa(e,this.hass,this.config);if(this.timeSchemeSelected)if(null!==t){let t=Be(wa(new Date,ot(this.hass),Te.twenty_four),this.hass);t=Ze(t,this.config.time_step,{wrapAround:!0});const o={start:Fe(t),actions:e.map(e=>eo(e,a[0]))};s=Object.assign(Object.assign({},s),{timeslots:[o]}),i=!1}else{const t=s.timeslots.map(e=>e.actions[0]),o=t.map(t=>to(t,e,a,this.hass));i=t.every((e,t)=>null!==o[t]&&aa(e,o[t][0])),s=Object.assign(Object.assign({},s),{timeslots:s.timeslots.map((e,t)=>Object.assign(e,{actions:o[t]||[]}))})}else if(null!==t){const t=to(s.timeslots[0].actions[0],e,a,this.hass)||e.map(e=>eo(e,a[0]));s=Object.assign(Object.assign({},s),{timeslots:[Object.assign(Object.assign({},s.timeslots[0]),{actions:t})]})}else s=Object.assign(Object.assign({},s),{timeslots:no}),i=!1;const o={schedule:s,actions:a,entities:e.map(e=>ut(e,this.hass,this.config))};return new Promise(e=>{if(i)e(o);else{const t={title:Zs("ui.dialog.confirm_migrate.title",ot(this.hass)),description:Zs("ui.dialog.confirm_migrate.description",ot(this.hass)),primaryButtonLabel:this.hass.localize("ui.common.yes"),secondaryButtonLabel:this.hass.localize("ui.common.no"),cancel:()=>{e(!1)},confirm:()=>{e(o)}};_t(this,{dialogTag:"generic-dialog",dialogImport:()=>Promise.resolve().then((function(){return oo})),dialogParams:t},this.cardEmbeddedInPopup)}})}};ro.styles=r`
    ${La}
  `,t([le()],ro.prototype,"hass",void 0),t([le()],ro.prototype,"config",void 0),t([le()],ro.prototype,"selectedGroup",void 0),t([le()],ro.prototype,"selectedAction",void 0),t([le()],ro.prototype,"entities",void 0),t([le()],ro.prototype,"schedule",void 0),t([le()],ro.prototype,"multipleEntity",void 0),t([le()],ro.prototype,"scheduleEntities",void 0),t([le()],ro.prototype,"timeSchemeSelected",void 0),t([le({type:Boolean})],ro.prototype,"editItem",void 0),ro=t([ne("scheduler-editor-entity")],ro);const lo=(e,t,i={})=>{const s=Ye(e);if(!s)return e;const a=t.states["sun.sun"],o="sunrise"==s.event?Be(a.attributes.next_rising,t):Be(a.attributes.next_setting,t);let n="+"==s.sign?o+Be(s.offset,t):o-Be(s.offset,t);return i.stepSize&&(n=Ze(n,i.stepSize)),Fe(n)},co=(e,t,i,s={})=>{Ye(e)&&(e=lo(e,i));const a=Be(e,i),o=i.states["sun.sun"],n=Be(o.attributes.next_rising,i),r=Be(o.attributes.next_setting,i);t||(t=Math.abs(a-n)<Math.abs(a-r)?zt.Sunrise:zt.Sunset);let l=a-(t==zt.Sunrise?Be(o.attributes.next_rising,i):Be(o.attributes.next_setting,i));return s.stepSize&&(l=Ze(l,s.stepSize,{maxHours:6})),`${t}${l>0?"+":"-"}${Fe(Math.abs(l))}`};let uo=class extends ae{constructor(){super(...arguments),this.stepSize=10,this.relativeMode=!1,this.event=zt.Sunrise,this.maxOffset=6}get time(){return this._time>=0?this._time:Math.abs(this._time)}set time(e){const t=Ze(e,this.stepSize,{wrapAround:!this.relativeMode,maxHours:this.relativeMode?this.maxOffset:void 0}),i=t!=this._time&&Xe(this._time);this._time=t,i&&this.updateValue()}firstUpdated(){const e=Ye(this.value);e?(this.relativeMode=!0,this.event=e.event==zt.Sunrise?zt.Sunrise:zt.Sunset,this.time="+"==e.sign?Be(e.offset,this.hass):-Be(e.offset,this.hass)):this.time=Be(this.value,this.hass)}updateValue(){if(this.relativeMode){const e=this._time>=0?"+":"-",t=Fe(this.time);this.value=`${this.event}${e}${t}`}else this.value=Fe(this.time);const e=new CustomEvent("change");this.dispatchEvent(e)}getTimeParts(){const e=(this.relativeMode?Fe(this.time):wa(xa(Fe(this.time)),ot(this.hass))).split(/:|\ /);return e[0]=String(Number(e[0])),e}render(){const e=this.getTimeParts();return I`
        ...
        ${this.relativeMode?I`
              <div class="suffix">
                ...
                <mwc-button @click=${this.toggleSunriseSunset}>
                  <ha-icon icon="mdi:${this.event==zt.Sunrise?"weather-sunny":"weather-night"}"></ha-icon>
                </mwc-button>
              </div>
            `:e.length>2?I`
              <div class="suffix">
  ...
  `,t([le()],uo.prototype,"hass",void 0),t([le({type:Number})],uo.prototype,"stepSize",void 0),t([le()],uo.prototype,"relativeMode",void 0),t([le()],uo.prototype,"event",void 0),t([le()],uo.prototype,"_time",void 0),uo=t([ne("time-picker")],uo);
/**
     * @license
     * Copyright 2018 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
     */
const mo="important",ho=Ta(class extends Da{constructor(e){var t;if(super(e),e.type!==Ca||"style"!==e.name||(null===(t=e.strings)||void 0===t?void 0:t.length)>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce((t,i)=>{const s=e[i];return null==s?t:t+`${i=i.includes("-")?i:i.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${s};`},"")}update(e,[t]){const{style:i}=e.element;if(void 0===this.ht){this.ht=new Set;for(const e in t)this.ht.add(e);return this.render(t)}this.ht.forEach(e=>{null==t[e]&&(this.ht.delete(e),e.includes("-")?i.removeProperty(e):i[e]="")});for(const e in t){const s=t[e];if(null!=s){this.ht.add(e);const t="string"==typeof s&&s.endsWith(" !important");e.includes("-")||t?i.setProperty(e,t?s.slice(0,-11):s,t?mo:""):i[e]=s}}return q}});let po=class extends ae{constructor(){super(),this.slots=[],this.actions=[],this.stepSize=10,this.isDragging=!1,this.currentTime=0,this.rangeMin=0,this.rangeMax=86400,this.activeSlot=null,this.activeMarker=null,this.previousSlot=null,this.timer=0,this.timeout=0,this.zoomFactor=1,this.timeSlotStyleFunction=null,this.large=!1,this.handleResize=this.handleResize.bind(this)}provideHass(e){e.hass=this.hass}handleResize(e){clearTimeout(this.timeout),this.timeout=window.setTimeout(()=>{this.requestUpdate()},50)}firstUpdated(){var e;window.addEventListener("resize",this.handleResize),this.timeSlotStyleFunction=this.compileTimeSlotStyleFunction(null===(e=this.config)||void 0===e?void 0:e.timeslot_style)}compileTimeSlotStyleFunction(e){if(!e)return null;try{const t=new Function("timeslot","i","active",`return (${e})(timeslot, i, active)`);return(e,i,s)=>{try{return Object.assign({},t.call(null,e,i,s))}catch(e){return console.error(`Error calling 'timeslot_style' function for timeslot ${i}:\n`,e.stack),{}}}}catch(e){return bt(this,I`
    ...
    `}renderSlots(){const e=parseFloat(getComputedStyle(this).getPropertyValue("width")),t=86400/(this.rangeMax-this.rangeMin)*e;let i=-this.rangeMin/(this.rangeMax-this.rangeMin)*e;return this.slots.map((s,a)=>{const o=((Be(s.stop,this.hass)||86400)-Be(s.start,this.hass))/86400,n=this.computeActionDisplay(s)||"",r=5*(n||"").length+10,l=i<0&&i+o*t>0?5-i:15,d=i+o*t>e&&i<e?o*t-(e-i)+5:15,c=o*t-l-d;i+=o*t;const u=(()=>{if(n&&(c>r/3||c>50)&&c>30)return I`
          ...
          `:""})(),m=(()=>{const e=this.timeSlotStyleFunction?this.timeSlotStyleFunction(s,a,this.activeSlot==a):void 0;return Object.assign({width:Math.floor(1e4*o)/100+"%"},e)})();return I`
        <div
    ...
    `}};t([le()],po.prototype,"hass",void 0),t([le()],po.prototype,"config",void 0),t([le({type:Array})],po.prototype,"slots",void 0),t([le({type:Array})],po.prototype,"actions",void 0),t([le({type:Number})],po.prototype,"stepSize",void 0),t([le()],po.prototype,"rangeMin",void 0),t([le()],po.prototype,"rangeMax",void 0),t([le()],po.prototype,"activeSlot",void 0),t([le()],po.prototype,"activeMarker",void 0),t([le({type:Boolean})],po.prototype,"large",void 0),t([function(e){return ce({finisher:(t,i)=>{Object.assign(t.prototype[i],e)}})}
/**
     * @license
     * Copyright 2017 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
     */({passive:!0})],po.prototype,"_handleTouchStart",null),po=t([ne("timeslot-editor")],po);const _o=async()=>{if(customElements.get("ha-checkbox")&&customElements.get("ha-slider")&&customElements.get("ha-combo-box"))return;await customElements.whenDefined("partial-panel-resolver");const e=document.createElement("partial-panel-resolver");e.hass={panels:[{url_path:"tmp",component_name:"config"}]},e._updateRoutes(),await e.routerOptions.routes.tmp.load(),await customElements.whenDefined("ha-panel-config");const t=document.createElement("ha-panel-config");await t.routerOptions.routes.automation.load()};let vo=class extends ae{constructor(){super(...arguments),this.min=0,this.max=255,this.step=1,this.scaleFactor=1,this.unit="",this.optional=!1,this.disabled=!1,this._displayedValue=0}set value(e){e=isNaN(e)?this.min:this._roundedValue(e/this.scaleFactor),this._displayedValue=e}firstUpdated(){(async()=>{await _o()})(),this.disabled&&!this.optional&&(this.disabled=!1,this.requestUpdate())}render(){return I`
    ...
    `:I``}toggleChecked(e){const t=e.target.checked;this.disabled=!t;const i=this.disabled?null:this._scaledValue(this._displayedValue);Pe(this,"value-changed",{value:i})}_updateValue(e){let t=Number(e.target.value);this._displayedValue=t,t=this._scaledValue(this._displayedValue),Pe(this,"value-changed",{value:t})}_roundedValue(e){return e=Math.round(e/this.step)*this.step,(e=parseFloat(e.toPrecision(12)))>this.max?e=this.max:e<this.min&&(e=this.min),e}_scaledValue(e){return e=this._roundedValue(e),e*=this.scaleFactor,e=parseFloat(e.toFixed(2))}};vo.styles=r`
    ${La} :host {
      width: 100%;
    }
    ha-slider {
  ...
  `,t([le({type:Number})],vo.prototype,"min",void 0),t([le({type:Number})],vo.prototype,"max",void 0),t([le({type:Number})],vo.prototype,"step",void 0),t([le({type:Number})],vo.prototype,"value",null),t([le({type:Number})],vo.prototype,"scaleFactor",void 0),t([le({type:String})],vo.prototype,"unit",void 0),t([le({type:Boolean})],vo.prototype,"optional",void 0),t([le({type:Boolean})],vo.prototype,"disabled",void 0),t([le({type:Number})],vo.prototype,"_displayedValue",void 0),vo=t([ne("variable-slider")],vo);let go=class extends ae{firstUpdated(){var e;null!==this.value&&void 0!==this.value||(null===(e=this.variable)||void 0===e?void 0:e.type)!=xt.Level||this.variable.optional||this.levelVariableUpdated(this.variable.min)}render(){return this.variable?this.variable.type==xt.Level?this.renderLevelVariable():this.variable.type==xt.List?this.renderListVariable():this.variable.type==xt.Text?this.renderTextVariable():I``:I``}levelVariableUpdated(e){const t="number"==typeof e?e:Number(e.detail.value);this.value=t,Pe(this,"value-changed",{value:t})}renderLevelVariable(){const e=this.variable,t=Number(this.value);return I`
      <variable-slider
        min=${e.min}
        max=${e.max}
        step=${e.step}
  ...
  `,t([le()],go.prototype,"variable",void 0),t([le()],go.prototype,"value",void 0),go=t([ne("scheduler-variable-picker")],go);let fo=class extends ae{constructor(){super(...arguments),this.activeEntry=null,this.activeMarker=null,this.timeslots=!1,this.editItem=!1,this.large=!1}firstUpdated(){if(!this.actions||!this.hass)return;this.timeslots||(this.activeEntry=0);const e=this.actions.map(e=>{const t=Object.assign(Object.assign({},e),{service_data:Ge(e.service_data||{},...Object.keys(e.variables||{}))});return Object.assign(e,{name:ha(t)})});e.sort(et),this.actions=e}shouldUpdate(e){return e.get("schedule")&&this.dispatchEvent(new CustomEvent("change",{detail:{schedule:this.schedule}})),!0}render(){return this.hass&&this.config&&this.entities&&this.actions?I`
      <div class="content">
        <div class="header">
          ${this.hass.localize("ui.panel.config.automation.editor.actions.type.device_id.action")}
        </div>
        ...
        ${this.timeslots?I`
              ${this.renderDays()}
              <div class="header">${Zs("ui.panel.time_picker.time_scheme",ot(this.hass))}</div>
        ...
        <div class="summary-action">
          ${this.timeslots?I`
                <div>
                  ...
                  ${tt(Zs("ui.panel.entity_picker.make_scheme",ot(this.hass)))}
                </div>
              `:I`
                <div>
    ...
    `:I``}renderDays(){if(!this.hass)return I``;let e=Array.from(Array(7).keys());const t=function(e){const t=e.match(/^([a-z]{2,3})(?:-([a-z]{3})(?=$|-))?(?:-([a-z]{4})(?=$|-))?(?:-([a-z]{2}|\d{3})(?=$|-))?/i),i=t[1],s=t[4],a="AEAFBHDJDZEGIQIRJOKWLYOMQASDSY".match(/../g),o="AGARASAUBDBRBSBTBWBZCACNCODMDOETGTGUHKHNIDILINJMJPKEKHKRLAMHMMMOMTMXMZNINPPAPEPHPKPRPTPYSASGSVTHTTTWUMUSVEVIWSYEZAZW".match(/../g),n="amasbndzengnguhehiidjajvkmknkolomhmlmrmtmyneomorpapssdsmsnsutatethtnurzhzu".match(/../g);return s?o.includes(s)?"sun":a.includes(s)?"sat":"mon":n.includes(i)?"sun":["ar","arq","arz","fa"].includes(i)?"sat":"mon"}(this.hass.language),i=e.length-ga.findIndex(e=>e.substr(0,3)==t);e=[...e.slice(-i),...e.slice(0,-i)];const s=e.map(e=>Object({value:ga[e].substr(0,3),name:fa(e,ot(this.hass),!0)})),a=[{value:Ot.Daily,name:Zs("ui.components.date.day_types_short.daily",ot(this.hass))},{value:Ot.Workday,name:Zs("ui.components.date.day_types_short.workdays",ot(this.hass))},{value:Ot.Weekend,name:Zs("ui.components.date.day_types_short.weekend",ot(this.hass))},{value:Ot.Custom,name:this.hass.localize("ui.panel.config.automation.editor.actions.type.choose.label")}];return I`
      <div class="header">${Zs("ui.components.date.days",ot(this.hass))}</div>
      <sc-button-group .items=${a} value=${ya(this.schedule.weekdays)} @change=${this.selectDays}>
      </sc-button-group>
      ${ya(this.schedule.weekdays)==Ot.Custom?I`
            <div>
              <sc-button-group
                .items=${s}
    ...
    `}updateMarkerSetting(e){const t=e.target.value,i=this.schedule.timeslots[this.activeMarker].start,s="time"==t?lo(i,this.hass,{stepSize:this.config.time_step}):co(i,t,this.hass,{stepSize:this.config.time_step});let a=[...this.schedule.timeslots];a=Object.assign(a,{[this.activeMarker-1]:Object.assign(Object.assign({},this.schedule.timeslots[this.activeMarker-1]),{stop:s}),[this.activeMarker]:Object.assign(Object.assign({},this.schedule.timeslots[this.activeMarker]),{start:s})}),this.schedule=Object.assign(Object.assign({},this.schedule),{timeslots:[...a]})}updateActiveEntry(e){null!==this.activeEntry&&(this.schedule=Object.assign(Object.assign({},this.schedule),{timeslots:Object.assign([...this.schedule.timeslots],{[this.activeEntry]:Object.assign(Object.assign({},this.schedule.timeslots[this.activeEntry]),e)})}))}updateActiveEntryAction(e,t){null!==this.activeEntry&&(e&&"service"in e?this.updateActiveEntry({actions:Object.assign([...this.schedule.timeslots[this.activeEntry].actions],{[t]:Object.assign(Object.assign({},this.schedule.timeslots[this.activeEntry].actions[t]),e)})}):e?Object.entries(e).forEach(([e,i])=>{let s=[...this.schedule.timeslots[this.activeEntry].actions],a="object"==typeof i&&e in this.schedule.timeslots[this.activeEntry].actions[t]?Object.assign(Object.assign({},s[t][e]),i):i;const o=Object.keys(a).filter(e=>null===a[e]);o.length&&(a=Ge(a,...o)),s=Object.assign(s,{[t]:Object.assign(Object.assign({},s[t]),{[e]:a})}),this.updateActiveEntry({actions:s})}):this.updateActiveEntry({actions:[...this.schedule.timeslots[this.activeEntry].actions].filter((e,i)=>i!=t)}))}handlePlannerUpdate(e){if(e.detail.hasOwnProperty("entries")){const t=e.detail.entries;t.length<this.schedule.timeslots.length&&this.activeEntry==this.schedule.timeslots.length-1&&(this.activeEntry=this.schedule.timeslots.length-2),this.schedule=Object.assign(Object.assign({},this.schedule),{timeslots:[...t]})}else e.detail.hasOwnProperty("entry")&&(this.activeMarker=null,this.activeEntry=null!==e.detail.entry?Number(e.detail.entry):null);e.detail.hasOwnProperty("marker")&&(this.activeEntry=null,this.activeMarker=null!==e.detail.marker?Number(e.detail.marker):null)}selectAction(e){if(!this.actions||null===this.activeEntry)return;const t=e.detail;t?this.entities.map(e=>e.id).forEach((e,i)=>{this.updateActiveEntryAction(eo(e,t),i)}):this.entities.forEach((e,t)=>{this.updateActiveEntryAction(null,t)})}getVariableEditor(){if(null===this.activeEntry||!this.actions)return I``;const e=[];return this.schedule.timeslots[this.activeEntry].actions.forEach(t=>{t=Ge(t,"entity_id"),this.actions.find(e=>aa(e,t,!0)&&Object.keys(e.variables||{}).length)&&(e.some(e=>Qe(e,t))||e.push(t))}),e.map(e=>Object.entries(this.actions.find(t=>aa(t,e,!0)).variables).map(([t,i])=>I`
          ...
          `))}selectDays(e){const t=e.target.value;let i=this.schedule.weekdays;if(Object.values(Ot).includes(t))switch(t){case Ot.Daily:i=["daily"];break;case Ot.Workday:i=["workday"];break;case Ot.Weekend:i=["weekend"];break;case Ot.Custom:i=[]}else i=t;this.schedule=Object.assign(Object.assign({},this.schedule),{weekdays:i})}};function yo(e,t,i){const s=e.getFullYear()==(new Date).getFullYear(),a=()=>{try{(new Date).toLocaleDateString("i")}catch(e){return"RangeError"===e.name}return!1};return i?Ce(e,"isoDate"):s?a()?new Intl.DateTimeFormat(t.language,{month:"long",day:"numeric"}).format(e):Ce(e,"MMMM D"):a()?new Intl.DateTimeFormat(t.language,{year:"numeric",month:"long",day:"numeric"}).format(e):Ce(e,"MMMM D, YYYY")}fo.styles=r`
    ${La}
    div.summary {
      display: grid;
  ...
  `,t([le()],fo.prototype,"hass",void 0),t([le()],fo.prototype,"config",void 0),t([le()],fo.prototype,"schedule",void 0),t([le()],fo.prototype,"actions",void 0),t([le()],fo.prototype,"entities",void 0),t([le()],fo.prototype,"activeEntry",void 0),t([le()],fo.prototype,"activeMarker",void 0),t([le({type:Boolean})],fo.prototype,"timeslots",void 0),t([le({type:Boolean})],fo.prototype,"editItem",void 0),t([le({type:Boolean})],fo.prototype,"large",void 0),fo=t([ne("scheduler-editor-time")],fo);let bo=class extends ae{constructor(){super(...arguments),this.label="",this.items=[],this.clearable=!1,this.icons=!1,this.disabled=!1,this.allowCustomValue=!1,this.invalid=!1}disconnectedCallback(){super.disconnectedCallback(),this._overlayMutationObserver&&(this._overlayMutationObserver.disconnect(),this._overlayMutationObserver=void 0)}open(){this.updateComplete.then(()=>{var e,t;null===(t=null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector("vaadin-combo-box-light"))||void 0===t||t.open()})}focus(){this.updateComplete.then(()=>{var e,t,i;null===(i=null===(t=null===(e=this.shadowRoot)||void 0===e?void 0:e.querySelector("vaadin-combo-box-light"))||void 0===t?void 0:t.inputElement)||void 0===i||i.focus()})}shouldUpdate(e){if(e.get("items"))if(Qe(this.items,e.get("items"))){if(1==e.size)return!1}else this.firstUpdated();return!0}firstUpdated(){(async()=>{await _o()})(),this._comboBox.items=this.items}render(){return I`
    ...
    `}};t([le()],bo.prototype,"label",void 0),t([le()],bo.prototype,"value",void 0),t([le()],bo.prototype,"items",void 0),t([le()],bo.prototype,"clearable",void 0),t([le()],bo.prototype,"icons",void 0),t([le({type:Boolean})],bo.prototype,"disabled",void 0),t([de()],bo.prototype,"_opened",void 0),t([le({attribute:"allow-custom-value",type:Boolean})],bo.prototype,"allowCustomValue",void 0),t([le({type:Boolean})],bo.prototype,"invalid",void 0),t([function(e,t){return ce({descriptor:t=>{const i={get(){var t,i;return null!==(i=null===(t=this.renderRoot)||void 0===t?void 0:t.querySelector(e))&&void 0!==i?i:null},enumerable:!0,configurable:!0};{const s="symbol"==typeof t?Symbol():"__"+t;i.get=function(){var t,i;return void 0===this[s]&&(this[s]=null!==(i=null===(t=this.renderRoot)||void 0===t?void 0:t.querySelector(e))&&void 0!==i?i:null),this[s]}}return i}})}("vaadin-combo-box-light")],bo.prototype,"_comboBox",void 0),bo=t([ne("scheduler-select")],bo);let ko=class extends ae{constructor(){super(...arguments),this.items=[],this.value=[],this.label="",this.invalid=!1}shouldUpdate(e){return e.get("items")&&(Qe(this.items,e.get("items"))||this.firstUpdated()),!0}firstUpdated(){this.value.some(e=>!this.items.map(e=>e.value).includes(e))&&(this.value=this.value.filter(e=>this.items.map(e=>e.value).includes(e)),Pe(this,"value-changed",{value:this.value}))}render(){return I`
      <div class="chip-set">
    ...
    `}};t([le()],ko.prototype,"items",void 0),t([le({type:Array})],ko.prototype,"value",void 0),t([le()],ko.prototype,"label",void 0),t([le({type:Boolean})],ko.prototype,"invalid",void 0),ko=t([ne("scheduler-selector")],ko);const wo=(e,t)=>{let i={};return(null==t?void 0:t.length)&&!t.includes($t.Above)||(i=Object.assign(Object.assign({},i),{[$t.Above]:{value:$t.Above,name:e.localize("ui.panel.config.automation.editor.triggers.type.numeric_state.above"),icon:"mdi:greater-than"}})),(null==t?void 0:t.length)&&!t.includes($t.Below)||(i=Object.assign(Object.assign({},i),{[$t.Below]:{value:$t.Below,name:e.localize("ui.panel.config.automation.editor.triggers.type.numeric_state.below"),icon:"mdi:less-than"}})),(null==t?void 0:t.length)&&!t.includes($t.Equal)||(i=Object.assign(Object.assign({},i),{[$t.Equal]:{value:$t.Equal,name:Zs("ui.panel.conditions.equal_to",ot(e)),icon:"mdi:equal"}})),(null==t?void 0:t.length)&&!t.includes($t.Unequal)||(i=Object.assign(Object.assign({},i),{[$t.Unequal]:{value:$t.Unequal,name:Zs("ui.panel.conditions.unequal_to",ot(e)),icon:"mdi:not-equal-variant"}})),i};let xo=class extends ae{constructor(){super(...arguments),this.editItem=!1,this.addCondition=!1,this.tags=[],this.startDate="",this.endDate=""}async firstUpdated(){var e,t,i;if(null===(e=this.config)||void 0===e?void 0:e.tags){(async()=>{await _o()})();const e=(await yt(this.hass)).map(e=>e.name),t=nt(this.config.tags);this.tags=[...e,...t.filter(t=>!e.includes(t)&&!["none","disabled","enabled"].includes(t))]}(await window.loadCardHelpers()).importMoreInfoControl("input_datetime"),this.startDate=(null===(t=this.schedule)||void 0===t?void 0:t.start_date)||yo(new Date,ot(this.hass),!0),this.endDate=(null===(i=this.schedule)||void 0===i?void 0:i.end_date)||yo(new Date,ot(this.hass),!0)}shouldUpdate(e){return e.get("schedule")&&this.dispatchEvent(new CustomEvent("change",{detail:{schedule:this.schedule}})),!0}render(){var e,t;if(!this.hass||!this.config||!this.schedule)return I``;let i=[{name:this.hass.localize("ui.panel.config.automation.editor.actions.type.repeat.label"),value:wt.Repeat,icon:"refresh"},{name:this.hass.localize("ui.dialogs.more_info_control.vacuum.stop"),value:wt.Pause,icon:"stop"},{name:this.hass.localize("ui.common.delete"),value:wt.Single,icon:"trash-can-outline"}];return Xe(this.schedule.start_date)&&(i=i.filter(e=>e.value!=wt.Repeat)),I`
        <div class="content">
          ${this.addCondition?this.renderAddCondition():I`
                  <div class="header">
                    ...
                    ${!this.schedule.timeslots[0].conditions||this.schedule.timeslots[0].conditions.length<2?"":I`
                          <div class="switch">
                            ${Zs("ui.panel.conditions.any",ot(this.hass))}
                            <ha-switch
                              style="margin: 0px 10px"
                              @change=${this.conditionTypeSwitchClick}
                              ?checked=${this.schedule.timeslots[0].condition_type==jt.All}
                            ></ha-switch>
                            ${Zs("ui.panel.conditions.all",ot(this.hass))}
                          </div>
                        `}
                  </div>
                  ...
                  <div class="condition-options">
                    ...
                    <div class="track-conditions">
                      ${this.schedule.timeslots[0].stop&&this.schedule.timeslots[0].conditions&&this.schedule.timeslots[0].conditions.length>0?I`
                            ...
                            >
                              ${Zs("ui.panel.conditions.track_conditions",ot(this.hass))}
                            </span>
                          `:""}
                    </div>
                  </div>

                  <div class="header">${Zs("ui.panel.options.period",ot(this.hass))}</div>
                  <div class="checkbox-container">
                    <div class="checkbox">
                      <ha-checkbox
                    ...
                    <div class="slider date-range">
                      <div>
                        <span>
                          ${it((null===(e=Zs("ui.components.date.days_range",ot(this.hass)).split("{").shift())||void 0===e?void 0:e.trim())||"")}
                        </span>
                        <ha-date-input
                      ...
                      <div>
                        <span>
                          ${it((null===(t=Zs("ui.components.date.days_range",ot(this.hass)).split("}")[1].split("{").shift())||void 0===t?void 0:t.trim())||"")}
                        </span>
                        <ha-date-input
                          .locale=${this.hass.locale}
                          value=${this.endDate}
                  ...
                  <div class="header">${Zs("ui.panel.options.repeat_type",ot(this.hass))}</div>
                  <sc-button-group
                    .items=${i}
    ...
    `}renderAddCondition(){if(!this.addCondition||!this.hass||!this.config)return I``;if(this.selectedEntity){const e=this.selectedEntity,t=Xa(e.id,this.hass,this.config);let i;if((null==t?void 0:t.type)==xt.Level)i=[$t.Above,$t.Below];else if((null==t?void 0:t.type)==xt.List)i=[$t.Equal,$t.Unequal];else{const t=e.id in this.hass.states?this.hass.states[e.id].state:null;i=!t||["unavailable","unknown"].includes(t)?[$t.Equal,$t.Unequal,$t.Above,$t.Below]:isNaN(Number(t))?[$t.Equal,$t.Unequal]:[$t.Above,$t.Below]}const s=wo(this.hass,i);return I`
      ...
      `}}selectGroup(e){this.selectedGroup=e.detail,this.selectedEntity=void 0}selectEntity(e){this.selectedEntity=e.detail,this.conditionMatchType=void 0,this.conditionValue=void 0}renderConditions(){if(!this.hass||!this.schedule)return I``;const e=this.schedule.timeslots[0].conditions||[];return e.length?e.map((e,t)=>{const i=ut(e.entity_id,this.hass,this.config),s=Xa(e.entity_id,this.hass,this.config);return I`
        <div class="summary">
          ...
          <span>
            ${it(i.name)} ${wo(this.hass)[e.match_type].name.toLowerCase()}
            ${s?s.type==xt.List?Ft(e.value,s):s.type==xt.Level?Pt(e.value,s):e.value:""}
          </span>
          <ha-icon-button
            .path=${Va}
  ...
  `,t([le()],xo.prototype,"hass",void 0),t([le()],xo.prototype,"config",void 0),t([le()],xo.prototype,"schedule",void 0),t([le()],xo.prototype,"selectedGroup",void 0),t([le()],xo.prototype,"selectedEntity",void 0),t([le()],xo.prototype,"conditionMatchType",void 0),t([le()],xo.prototype,"conditionValue",void 0),t([le()],xo.prototype,"editConditionItem",void 0),t([le({type:Boolean})],xo.prototype,"editItem",void 0),t([le()],xo.prototype,"addCondition",void 0),t([le()],xo.prototype,"tags",void 0),t([de()],xo.prototype,"startDate",void 0),t([de()],xo.prototype,"endDate",void 0),xo=t([ne("scheduler-editor-options")],xo);let $o=class extends ae{constructor(){super(...arguments),this.actions=[],this.editItem=null,this.large=!1,this._currTab=Ue.Entity,this._tabs=[Ue.Entity,Ue.Time,Ue.Options]}provideHass(e){e.hass=this.hass}async showDialog(e){this._params=e,this._config=e.config,this.entities=e.entities,this.actions=e.actions,this.schedule=e.schedule,this.editItem=e.editItem,this.cardEmbeddedInPopup=e.cardEmbeddedInPopup,this._currTab=null!==this.editItem?Ue.Time:Ue.Entity,await this.updateComplete}async closeDialog(){this._params=void 0,this.large=!1}render(){var e,t,i,s;const a=null===(e=this.schedule)||void 0===e?void 0:e.timeslots.every(e=>e.stop),o=e=>e==Ue.Entity?this.hass.localize("ui.components.entity.entity-picker.entity"):e==Ue.Time?this.hass.localize("ui.dialogs.helper_settings.input_datetime.time"):e==Ue.Options?this.hass.localize("ui.dialogs.helper_settings.input_select.options"):e;return this._params?I`
      <ha-dialog open @closed=${this.closeDialog} .heading=${!0} hideActions scrimClickAction="">
        <ha-dialog-header slot="heading">
          ...
          <span slot="title" @click=${this._enlarge}>
            ${this.editItem?(null===(t=this.schedule)||void 0===t?void 0:t.name)?null===(i=this.schedule)||void 0===i?void 0:i.name:Zs("ui.panel.common.default_name",ot(this.hass),"{id}",this.editItem):Zs("ui.panel.common.new_schedule",ot(this.hass))}
          </span>
        </ha-dialog-header>
        <sl-tab-group
    ...
    `:I``}_handleUpdateParams(e){const t=e.detail;t.schedule&&(this.schedule=t.schedule),t.actions&&(this.actions=t.actions),t.entities&&(this.entities=t.entities),t.tab&&(this._currTab=t.tab)}_handleTabChanged(e){const t=this._currTab,i=e.detail.name;i==Ue.Time||this.schedule?i!==t&&(this._currTab=i):e.preventDefault()}_enlarge(){this.large=!this.large}async _handleSaveClick(){if(!this.hass)return;let e=Object.assign({},this.schedule);if(e=Object.assign(Object.assign({},e),{timeslots:e.timeslots.map(e=>{var t;return e.actions&&e.actions.length?(e.actions.some(e=>!e.entity_id||"notify"==De(e.entity_id||""))&&(e=Object.assign(Object.assign({},e),{actions:e.actions.map(e=>e.entity_id&&"notify"!=De(e.entity_id||"")?e:Ge(e,"entity_id"))})),e.stop||(e=Ge(e,"stop")),(null===(t=e.conditions)||void 0===t?void 0:t.length)||(e=Ge(e,"conditions","condition_type")),e):null}).filter(Xe)}),this.editItem){const s=await gt(this.hass,this.editItem);if(Qe(Ge(e,"timeslots"),Ge(We(s,Object.keys(e)),"timeslots"))&&e.timeslots.length==s.timeslots.length&&e.timeslots.every((e,t)=>Qe(e,s.timeslots[t])));else{if(!s.enabled){await new Promise(e=>{const t={title:Zs("ui.dialog.enable_schedule.title",ot(this.hass)),description:Zs("ui.dialog.enable_schedule.description",ot(this.hass)),primaryButtonLabel:this.hass.localize("ui.common.yes"),secondaryButtonLabel:this.hass.localize("ui.common.no"),cancel:()=>{e(!1)},confirm:()=>{e(!0)}};_t(this,{dialogTag:"generic-dialog",dialogImport:()=>Promise.resolve().then((function(){return oo})),dialogParams:t},this.cardEmbeddedInPopup)})&&this.hass.callService("switch","turn_on",{entity_id:s.entity_id})}(function(e){return!!e&&null!==e.match(/^Schedule\ #[a-f0-9]{6}/)})(e.name)&&(e=Object.assign(Object.assign({},e),{name:""})),(t=this.hass,i=Object.assign(Object.assign({},e),{schedule_id:this.editItem}),t.callApi("POST","scheduler/edit",i)).catch(e=>kt(e,this,this.hass,this.cardEmbeddedInPopup)).then(()=>{this.closeDialog()})}}else((e,t)=>e.callApi("POST","scheduler/add",t))(this.hass,e).catch(e=>kt(e,this,this.hass,this.cardEmbeddedInPopup)).then(()=>{this.closeDialog()});var t,i}async _handleDeleteClick(e){if(console.log(this.hass.localize("ui.common.ok")),!this.editItem)return;e.target;await new Promise(e=>{const t={title:Zs("ui.dialog.confirm_delete.title",ot(this.hass)),description:Zs("ui.dialog.confirm_delete.description",ot(this.hass)),primaryButtonLabel:this.hass.localize("ui.common.ok"),secondaryButtonLabel:this.hass.localize("ui.common.cancel"),cancel:()=>{e(!1)},confirm:()=>{e(!0)}};_t(this,{dialogTag:"generic-dialog",dialogImport:()=>Promise.resolve().then((function(){return oo})),dialogParams:t},this.cardEmbeddedInPopup)})&&ft(this.hass,this.editItem).catch(e=>kt(e,this,this.hass,this.cardEmbeddedInPopup)).then(()=>{this.closeDialog()})}static get styles(){return r`
      ${Ia}
      sl-tab {
        flex: 1;
        text-align: center;
      }
    `}};t([le()],$o.prototype,"_config",void 0),t([de()],$o.prototype,"_params",void 0),t([le()],$o.prototype,"editItem",void 0),t([le({type:Boolean,reflect:!0})],$o.prototype,"large",void 0),t([de()],$o.prototype,"_currTab",void 0),$o=t([ne("scheduler-editor-dialog")],$o);var jo=Object.freeze({__proto__:null,get SchedulerEditorDialog(){return $o}});let zo=class extends ae{constructor(){super(...arguments),this.scheduleEntities=[],this._cardTab=0,this.selectedDomain=""}setConfig(e){this._config=e}async firstUpdated(){await _o(),this.scheduleEntities=(await vt(this.hass)).map(e=>e.entity_id);const e=(await yt(this.hass)).map(e=>e.name);e.sort(et),this.tagOptions=e}render(){return this.hass&&this._config?I`
      <sl-tab-group .selected=${this._cardTab?1:0} @iron-activate=${this._selectTab}>
        ...
        >
          ${Zs("ui.panel.card_editor.tabs.entities",ot(this.hass))}
        </sl-tab>
        <sl-tab
          slot="nav"
          panel="0"
        ...
        >
          ${Zs("ui.panel.card_editor.tabs.other",ot(this.hass))}
        </sl-tab>
      </sl-tab-group>

      <div class="card-config">
        ${this._cardTab?I`
              <div class="header">${Zs("ui.panel.card_editor.fields.title.heading",ot(this.hass))}</div>
              <sc-button-group
                .items=${[{name:Zs("ui.panel.card_editor.fields.title.options.standard",ot(this.hass)),value:"standard"},{name:Zs("ui.panel.card_editor.fields.title.options.hidden",ot(this.hass)),value:"hidden"},{name:Zs("ui.panel.card_editor.fields.title.options.custom",ot(this.hass)),value:"custom"}]}
              ...
              ${"string"==typeof this._config.title?I`
                    <ha-textfield
                      label=${Zs("ui.panel.card_editor.fields.title.custom_title",ot(this.hass))}
              ...
              <div class="header">
                ${Zs("ui.panel.card_editor.fields.discover_existing.heading",ot(this.hass))}
              </div>
              <div class="text-field">
                ${Zs("ui.panel.card_editor.fields.discover_existing.description",ot(this.hass))}
              </div>
              <ha-switch
              ...
              <div class="header">
                ${Zs("ui.panel.card_editor.fields.time_step.heading",ot(this.hass))}
              </div>
              <div class="text-field">
                ${Zs("ui.panel.card_editor.fields.time_step.description",ot(this.hass))}
              </div>
              <variable-slider
                min="1"
                max="30"
              ...
              <div class="header">
                ${Zs("ui.panel.card_editor.fields.sort_by.heading",ot(this.hass))}
              </div>
              <div class="text-field">
                ${Zs("ui.panel.card_editor.fields.sort_by.description",ot(this.hass))}
              </div>

              <div>
                <ha-formfield
                  label=${Zs("ui.panel.card_editor.fields.sort_by.options.relative_time",ot(this.hass))}
                >
                  <ha-radio
                    name="sort_by"
                ...
                <ha-formfield
                  label=${Zs("ui.panel.card_editor.fields.sort_by.options.title",ot(this.hass))}
                >
                  <ha-radio
                    name="sort_by"
              ...
              <div>
                <ha-formfield
                  label=${Zs("ui.panel.card_editor.fields.sort_by.options.state",ot(this.hass))}
                >
                  <ha-checkbox
              ...
              <div class="header">
                ${Zs("ui.panel.card_editor.fields.display_format_primary.heading",ot(this.hass))}
              </div>
              <div class="text-field">
                ${Zs("ui.panel.card_editor.fields.display_format_primary.description",ot(this.hass))}
              </div>

              <ha-formfield
                label=${Zs("ui.panel.card_editor.fields.display_format_primary.options.default",ot(this.hass))}
              >
                <ha-radio
                  name="primary_info"
              ...
              <ha-formfield
                label=${Zs("ui.panel.card_editor.fields.display_format_primary.options.entity_action",ot(this.hass))}
              >
                <ha-radio
                  name="primary_info"
              ...
              <div class="header">
                ${Zs("ui.panel.card_editor.fields.display_format_secondary.heading",ot(this.hass))}
              </div>
              <div class="text-field">
                ${Zs("ui.panel.card_editor.fields.display_format_secondary.description",ot(this.hass))}
              </div>

              <ha-formfield
                label=${Zs("ui.panel.card_editor.fields.display_format_secondary.options.relative_time",ot(this.hass))}
              >
                <ha-checkbox
              ...
              <ha-formfield
                label=${Zs("ui.panel.card_editor.fields.display_format_secondary.options.time",ot(this.hass))}
              >
                <ha-checkbox
              ...
              <ha-formfield
                label=${Zs("ui.panel.card_editor.fields.display_format_secondary.options.days",ot(this.hass))}
              >
                <ha-checkbox
              ...
              <ha-formfield
                label=${Zs("ui.panel.card_editor.fields.display_format_secondary.options.additional_tasks",ot(this.hass))}
              >
                <ha-checkbox
              ...
              <div class="header">
                ${Zs("ui.panel.card_editor.fields.show_header_toggle.heading",ot(this.hass))}
              </div>
              <div class="text-field">
                ${Zs("ui.panel.card_editor.fields.show_header_toggle.description",ot(this.hass))}
              </div>
              <ha-switch
              ...
              ${void 0!==this.tagOptions?I`
                    <div class="header">
                      ${Zs("ui.panel.card_editor.fields.tags.heading",ot(this.hass))}
                    </div>
                    <div class="text-field">
                      ${Zs("ui.panel.card_editor.fields.tags.description",ot(this.hass))}
                    </div>
                    <scheduler-selector
                      .items=${this.getTagOptions()}
    ...
    `:I``}_selectTab(e){this._cardTab=parseInt(e.detail.name)}_updateConfig(e){this._config&&(this._config=Object.assign(Object.assign({},this._config),e),Pe(this,"config-changed",{config:this._config}))}_setTitleFormatOption(e){var t;this.hass&&("standard"==e?this._updateConfig({title:!0}):"hidden"==e?this._updateConfig({title:!1}):this._updateConfig({title:"string"==typeof(null===(t=this._config)||void 0===t?void 0:t.title)?this._config.title:Zs("ui.panel.common.title",ot(this.hass))}))}getTitleOption(){return this.hass&&this._config?"string"==typeof this._config.title?"custom":this._config.title?"standard":"hidden":""}updateTags(e){if(!this._config||!this.hass)return;let t=e.target.value;t=t.map(e=>e.trim()),t.sort(et),this._updateConfig({tags:t})}getTagOptions(){if(!this._config||!this.hass)return[];let e=this.tagOptions||[];if(this._config.tags){const t=nt(this._config.tags);e=[...e,...t.filter(t=>!e.includes(t))]}return e.map(e=>Object({name:e,value:e}))}_setSortBy(e){var t;const i=e.target.checked,s=e.target.value;let a=nt((null===(t=this._config)||void 0===t?void 0:t.sort_by)||He.sort_by);"state"!=s&&i&&(a=a.filter(e=>"state"==e)),!a.includes(s)&&i&&(a=[...a,s]),a.includes(s)&&!i&&(a=a.filter(e=>e!=s)),this._updateConfig({sort_by:a})}_setDisplayOptionsPrimary(e){var t;const i=e.target.value,s=Object.assign(Object.assign({},(null===(t=this._config)||void 0===t?void 0:t.display_options)||He.display_options),{primary_info:i});this._updateConfig({display_options:s})}_setDisplayOptionsSecondary(e){var t;const i=e.target.value,s=e.target.checked;let a=Object.assign({},(null===(t=this._config)||void 0===t?void 0:t.display_options)||He.display_options),o=nt(a.secondary_info||[]);o=s?Array.from(new Set([...o,i])):o.filter(e=>e!==i),o.sort((e,t)=>{const i={"relative-time":1,time:o.includes("relative-time")?3:2,days:o.includes("relative-time")?2:3,"additional-tasks":4},s=Object.keys(i).includes(e)?i[e]:5,a=Object.keys(i).includes(t)?i[t]:5;return s>a?1:s<a?-1:0}),a=Object.assign(Object.assign({},a),{secondary_info:[...o]}),this._updateConfig({display_options:a})}getDomainSwitches(){if(!this._config||!this.hass)return;const e=Qa(this.hass,Object.assign(Object.assign({},He),{include:["*"]}),{filterActions:!0,filterStates:!0}).filter(e=>"switch"!==De(e)||!this.scheduleEntities.includes(e)).map(e=>ut(e,this.hass,{})).filter(e=>Ka(e.id,this.hass)||pa(e.id,this.hass,He)),t=e.map(e=>De(e.id)).filter((e,t,i)=>i.indexOf(e)===t);return t.sort((e,t)=>e.trim().toLowerCase()<t.trim().toLowerCase()?-1:1),t.map(t=>{var i;const s=e.filter(e=>De(e.id)==t).length,a=e.filter(e=>De(e.id)==t),o=a.filter(e=>va(e.id,this._config)).length;return s?I`
        <div class="row" @click=${()=>this.toggleShowDomain(t)}>
          ...
          <div class="info">
            ${t}
            <div class="secondary">
              ${Zs("ui.panel.card_editor.fields.entities.included_number",ot(this.hass),["{number}","{total}"],[o,s])}
            </div>
          </div>
          <ha-switch
            @click=${e=>e.stopPropagation()}
            @change=${e=>this.toggleSelectEntity(t,e.target.checked)}
            ?checked=${va(t,this._config)}
            ?disabled=${va(t,{groups:null===(i=this._config)||void 0===i?void 0:i.groups})}
          >
          </ha-switch>
        </div>
        ${this.selectedDomain==t?I`
              ...
              ${a.map(e=>{var i,s;return I`
                  <div class="row" @click=${()=>this.toggleSelectEntity(e.id)}>
                    ...
                    <ha-switch
                      ?checked=${va(e.id,this._config)}
                      ?disabled=${va(e.id,{groups:null===(i=this._config)||void 0===i?void 0:i.groups})||va(t,{groups:null===(s=this._config)||void 0===s?void 0:s.groups})}
                    ></ha-switch>
                  </div>
                `})}
              <div class="divider"></div>
            `:""}
      `:""})}toggleShowDomain(e){this._config&&this.hass&&(this.selectedDomain!=e?this.selectedDomain=e:this.selectedDomain="")}toggleSelectEntity(e,t){if(!this._config||!this.hass)return;const i=va(e,this._config);void 0===t&&(t=!i);const s=De(e);let a=[...this._config.include||[]],o=[...this._config.exclude||[]];if(!i&&t)o.includes(e)&&(o=o.filter(t=>t!=e)),a.includes(e)||(a=[...a,e]);else{if(!i||t)return;(s&&a.includes(s)||va(e,{customize:this._config.customize})||s&&va(s,{customize:this._config.customize}))&&(o=[...o,e]),a.includes(e)&&(a=a.filter(t=>t!=e))}a.sort(et),o.sort(et),this._updateConfig({include:a,exclude:o})}static get styles(){return r`
      ${La}
      sl-tab {
        flex: 1;
        text-align: center;
    ...
    `}};t([le()],zo.prototype,"hass",void 0),t([le()],zo.prototype,"_config",void 0),t([le()],zo.prototype,"scheduleEntities",void 0),t([le()],zo.prototype,"tagOptions",void 0),t([de()],zo.prototype,"_cardTab",void 0),t([le()],zo.prototype,"selectedDomain",void 0),zo=t([ne("scheduler-card-editor")],zo);let Oo=class extends ae{constructor(){super(...arguments),this.updateInterval=60,this.timer=0}startRefreshTimer(e){clearInterval(this.timer),this.timer=window.setInterval(()=>{this.requestUpdate()},1e3*e),this.updateInterval=e}set hass(e){this._hass=e,this.startRefreshTimer(this.updateInterval)}relativeTime(e){if(!this._hass)return"";const t=new Date;let i=(t.getTime()-e.getTime())/1e3;const s=i>=0?"past":"future";i=Math.abs(i);const a=Math.round(i);if("future"==s&&a>0){if(i/3600>=6){const i=t.setHours(0,0,0,0),s=Math.floor((e.valueOf()-i.valueOf())/864e5);let a="";s>14?a=yo(e,ot(this._hass)):s>7?a=Zs("ui.components.date.next_week_day",ot(this._hass),"{weekday}",fa(e,ot(this._hass))):1==s?a=Zs("ui.components.date.tomorrow",ot(this._hass)):s>0&&(a=fa(e,ot(this._hass)));let o=Zs("ui.components.time.absolute",ot(this._hass),"{time}",wa(e,ot(this._hass)));return 12==e.getHours()&&0==e.getMinutes()?o=Zs("ui.components.time.at_noon",ot(this._hass)):0==e.getHours()&&0==e.getMinutes()&&(o=Zs("ui.components.time.at_midnight",ot(this._hass))),String(a+" "+o).trim()}if(Math.round(i/60)>60&&Math.round(i/60)<120){const e=Math.round(i/60-60),t=this._hass.localize("ui.common.and");return`${new Intl.RelativeTimeFormat(ot(this._hass).language,{numeric:"auto"}).format(1,"hour")} ${t} ${Intl.NumberFormat(ot(this._hass).language,{style:"unit",unit:"minute",unitDisplay:"long"}).format(e)}`}if(Math.round(i)>60&&Math.round(i)<120){const e=Math.round(i-60),t=this._hass.localize("ui.common.and");return`${new Intl.RelativeTimeFormat(ot(this._hass).language,{numeric:"auto"}).format(1,"minute")} ${t} ${Intl.NumberFormat(ot(this._hass).language,{style:"unit",unit:"second",unitDisplay:"long"}).format(e)}`}}const o=function(e,t,i){void 0===t&&(t=Date.now()),void 0===i&&(i={});var s=It(It({},qt),i||{}),a=(+e-+t)/1e3;if(Math.abs(a)<s.second)return{value:Math.round(a),unit:"second"};var o=a/60;if(Math.abs(o)<s.minute)return{value:Math.round(o),unit:"minute"};var n=a/3600;if(Math.abs(n)<s.hour)return{value:Math.round(n),unit:"hour"};var r=a/86400;if(Math.abs(r)<s.day)return{value:Math.round(r),unit:"day"};var l=new Date(e),d=new Date(t),c=l.getFullYear()-d.getFullYear();if(Math.round(Math.abs(c))>0)return{value:Math.round(c),unit:"year"};var u=12*c+l.getMonth()-d.getMonth();if(Math.round(Math.abs(u))>0)return{value:Math.round(u),unit:"month"};var m=a/604800;return{value:Math.round(m),unit:"week"}}(e);return new Intl.RelativeTimeFormat(ot(this._hass).language,{numeric:"auto"}).format(o.value,o.unit)}render(){if(!this._hass||!this.datetime)return I``;const e=new Date,t=Math.round((this.datetime.valueOf()-e.valueOf())/1e3);let i=60;return Math.abs(t)<=150&&(i=Math.max(Math.ceil(Math.abs(t))/10,2)),this.updateInterval!=i&&this.startRefreshTimer(i),I`
      ${tt(this.relativeTime(this.datetime))}
    `}};t([le()],Oo.prototype,"_hass",void 0),t([le()],Oo.prototype,"datetime",void 0),Oo=t([ne("my-relative-time")],Oo),window.customCards=window.customCards||[],window.customCards.push({type:"scheduler-card",name:"Scheduler Card",description:"Card to manage schedule entities made with scheduler-component."}),console.info("%c  SCHEDULER-CARD  \n%c  Version: "+"v3.2.15".padEnd(7," "),"color: orange; font-weight: bold; background: black","color: white; font-weight: bold; background: dimgray");const So=e=>new Date(e.timestamps[e.next_entries[0]]).valueOf(),Eo=(e,t)=>{var i,s;if(!e.timeslots.every(e=>e.actions.every(e=>va(e.entity_id||e.service,t))))return!1;let a=!0;const o=nt(t.tags);o.length&&(a=!1,((e.tags||[]).some(e=>o.includes(e))||o.includes("none")&&!(null===(i=e.tags)||void 0===i?void 0:i.length)||o.includes("enabled")&&e.enabled||o.includes("disabled")&&!e.enabled)&&(a=!0));const n=nt(t.exclude_tags);return n.length&&a&&((e.tags||[]).some(e=>n.includes(e))||n.includes("none")&&!(null===(s=e.tags)||void 0===s?void 0:s.length)||n.includes("enabled")&&e.enabled||n.includes("disabled")&&!e.enabled)&&(a=!1),a},Ao=(e,t)=>!!t.discover_existing||!!e&&Eo(e,t),Co=(e,t,i)=>({primaryInfo:$a(e,t,i),secondaryInfo:ja(e,t,i),icon:za(e,t,i)});e.SchedulerCard=class extends(Aa(ae)){constructor(){super(...arguments),this.showDiscovered=!1,this.translationsLoaded=!1,this.scheduleDisplayInfo={},this.connectionError=!1}static getConfigElement(){return document.createElement("scheduler-card-editor")}hassSubscribe(){return this.loadSchedules(),[this.hass.connection.subscribeMessage(e=>this.updateScheduleItem(e),{type:"scheduler_updated"})]}firstUpdated(){const e=this.hass;if(e.localize("ui.panel.config.automation.editor.actions.type.device_id.action"))this.translationsLoaded=!0;else{document.querySelector("home-assistant")._loadFragmentTranslations(e.language,"config").then(()=>{this.hass.localize})}}provideHass(e){e.hass=this.hass}async updateScheduleItem(e){var t;"scheduler_item_removed"!=e.event?gt(this.hass,e.schedule_id).then(t=>{var i;const s=null===(i=this.schedules)||void 0===i?void 0:i.find(t=>t.schedule_id==e.schedule_id);let a=[...this.schedules||[]];try{this.scheduleDisplayInfo=Object.assign(Object.assign({},this.scheduleDisplayInfo),{[t.schedule_id]:Co(t,this._config,this.hass)})}catch(e){}t&&Ao(t,this._config)?a=s?So(s)==So(t)?a.map(e=>e.schedule_id==t.schedule_id?t:e):this.sortSchedules(a.map(e=>e.schedule_id==t.schedule_id?t:e)):this.sortSchedules([...a,t]):s&&(a=a.filter(t=>t.schedule_id!=e.schedule_id)),this.schedules=[...a]}):this.schedules=null===(t=this.schedules)||void 0===t?void 0:t.filter(t=>t.schedule_id!=e.schedule_id)}async loadSchedules(){vt(this.hass).then(e=>{const t=e.filter(e=>Ao(e,this._config));let i={};Object.keys(t).forEach(e=>{try{i=Object.assign(Object.assign({},i),{[t[e].schedule_id]:Co(t[e],this._config,this.hass)})}catch(e){}}),this.scheduleDisplayInfo=i,this.schedules=this.sortSchedules(t)}).catch(e=>{this.schedules=[],this.connectionError=!0})}shouldUpdate(e){const t=e.get("hass"),i=e.get("_config");if(t&&1==e.size&&!this.translationsLoaded&&(t.localize("ui.panel.config.automation.editor.actions.type.device_id.action")||(this.translationsLoaded=!0)),i&&this._config){Object.keys(i).filter(e=>i[e]!==this._config[e]).some(e=>["tags","discover_existing","sort_by","display_options"].includes(e))&&(async()=>{await this.loadSchedules()})()}return!t||1!=e.size||!this.schedules||this.schedules.some(e=>JSON.stringify(t.states[e.entity_id])!==JSON.stringify(this.hass.states[e.entity_id]))}setConfig(e){rt(e);const t=Object.assign(Object.assign({},He),e);this._config=t}async getCardSize(){return new Promise(e=>{let t=0;const i=setInterval(()=>{if(t++,!this._config||!this.schedules&&!this.connectionError&&t<50)return;let s=this._config.title||this._config.show_header_toggle?3:1;this._config.show_add_button&&(s+=1);const a=((nt(this._config.display_options.secondary_info||[]).length||2)+1)/2;this.schedules&&(s+=this.showDiscovered?this.schedules.length*a:this.schedules.filter(e=>Eo(e,this._config)).length*a),clearInterval(i),e(Math.round(s))},50)})}render(){return this.hass&&this._config&&this.schedules?I`
      <ha-card>
        <div class="card-header">
          <div class="name">
            ${this._config.title?"string"==typeof this._config.title?this._config.title:Zs("ui.panel.common.title",ot(this.hass)):""}
          </div>
    ...
    `:I``}renderRows(){if(!this._config||!this.hass||!this.schedules)return I``;if(this.connectionError)return I`
        <div>
          <hui-warning>
            ${Zs("ui.panel.overview.backend_error",ot(this.hass))}
          </hui-warning>
        </div>
      `;if(!Object.keys(this.schedules).length)return I`
        <div>
          ${Zs("ui.panel.overview.no_entries",ot(this.hass))}
        </div>
      `;const e=this.schedules.filter(e=>Eo(e,this._config)),t=this.schedules.filter(e=>!Eo(e,this._config));return I`
      ...
      ${Object.keys(t).length?this.showDiscovered?I`
              ...
              <div>
                ...
                >
                  ${tt(Zs("ui.panel.overview.hide_excluded",ot(this.hass)))}
                </button>
              </div>
            `:I`
              <div>
                ...
                >
                  +
                  ${Zs("ui.panel.overview.excluded_items",ot(this.hass),"{number}",t.length)}
                </button>
              </div>
            `:""}
    ...
    `}renderDisplayItems(e,t){const i=t=>{const i=t.split("<my-relative-time></my-relative-time>");if(i.length>1)return I`
          ...
          ${i[1]?Pa(i[1]):""}
        `;const s=t.split(/(<tag>[^<]*<\/tag>)/g);return s.length>1?s.filter(e=>e.length).map(e=>{const t=e.match(/<tag>([^<]*)<\/tag>/g);return t?Pa(`<span class="filter-tag">${t[0]}</span>`):e}):Pa(t)};return t.filter(Xe).map(e=>I`
          ${i(e)}<br />
        `)}sortSchedules(e){var t;const i=nt(null===(t=this._config)||void 0===t?void 0:t.sort_by);if(i.includes("relative-time")&&(e=(e=>{const t=[...e];return t.sort((e,t)=>{const i=So(e),s=So(t),a=(new Date).valueOf(),o=i<a&&s<a;return null!==i&&null!==s?i<a&&s>=a?1:i>=a&&s<a?-1:i>s?o?-1:1:i<s?o?1:-1:e.entity_id<t.entity_id?1:-1:null!==s?1:null!==i?-1:e.entity_id<t.entity_id?1:-1}),t})(e)),i.includes("title")&&(e=((e,t)=>{const i=[...e];return i.sort((e,i)=>{if(!t[e.schedule_id])return t[i.schedule_id]?1:-1;return et(t[e.schedule_id].primaryInfo.join(""),t[i.schedule_id].primaryInfo.join(""))}),i})(e,this.scheduleDisplayInfo)),i.includes("state")){const t=i.includes("relative-time");e=((e,t,i)=>{const s=[...e];return s.sort((e,s)=>{var a,o;const n=null===(a=t.states[e.entity_id])||void 0===a?void 0:a.state,r=null===(o=t.states[s.entity_id])||void 0===o?void 0:o.state,l=["on","triggered"].includes(n),d=["on","triggered"].includes(r);if(l&&!d)return-1;if(!l&&d)return 1;if(i){if("off"!=n&&"off"==r)return 1;if("off"==n&&"off"!=r)return-1}return 0}),s})(e,this.hass,t)}return e}toggleDisabled(e,t){if(!this.hass||!t)return;e.stopPropagation();const i=!e.target.checked;this.hass.callService("switch",i?"turn_on":"turn_off",{entity_id:t})}toggleDisableAll(e){if(!this.hass||!this.schedules)return;const t=e.target.checked;this.schedules.filter(e=>this.showDiscovered?Ao(e,this._config):Eo(e,this._config)).forEach(e=>{this.hass.callService("switch",t?"turn_on":"turn_off",{entity_id:e.entity_id})})}computeHeaderToggleState(){if(!this.schedules)return!1;return this.schedules.filter(e=>this.showDiscovered?Ao(e,this._config):Eo(e,this._config)).some(e=>{var t;return["on","triggered"].includes((null===(t=this.hass.states[e.entity_id])||void 0===t?void 0:t.state)||"")})}_addItemClick(){_t(this,{dialogTag:"scheduler-editor-dialog",dialogImport:()=>Promise.resolve().then((function(){return jo})),dialogParams:{config:this._config,editItem:null,entities:[],actions:[],schedule:void 0}})}async _editItemClick(e){if(!this.hass||!this._config)return;const t=await gt(this.hass,e);if(!t)return;const i=Je(Ke(t.timeslots.map(e=>e.actions.map(e=>e.entity_id||e.service)))),s=i.map(e=>ut(e,this.hass,this._config));let a=pa(i,this.hass,this._config);const o=Je(Ke(t.timeslots.map(e=>e.actions))),n=o.filter(e=>!a.some(t=>aa(t,e,!0)));n.length&&Je(n).forEach(e=>a.push(_a(e,this.hass)));let r={weekdays:t.weekdays,timeslots:t.timeslots,repeat_type:t.repeat_type,name:t.name,tags:t.tags||[],start_date:t.start_date,end_date:t.end_date};if(s.length&&r.timeslots.length){if(r.timeslots.every(e=>e.stop)){if(r=Object.assign(Object.assign({},r),{timeslots:at(r.timeslots,this.hass)}),!a.length)return kt({error:"",body:{message:`Could not compute actions for the schedule #${e}.`}},this,this.hass)}else if(a=a.filter(e=>o.find(t=>aa(e,t,!0))).reduce((e,t)=>[t],[]),!a.length)return kt({error:"",body:{message:`Could not compute actions for schedule #${e}.`}},this,this.hass);_t(this,{dialogTag:"scheduler-editor-dialog",dialogImport:()=>Promise.resolve().then((function(){return jo})),dialogParams:{config:this._config,editItem:t.schedule_id,actions:a,entities:s,schedule:r,cardEmbeddedInPopup:ht(this)}})}else{await new Promise(e=>{const t={title:"Defective entity",description:"This schedule is defective and cannot be edited with the card. Consider to delete the item and recreate it. If the problem persists, please report the issue on GitHub.",primaryButtonLabel:this.hass.localize("ui.common.delete"),primaryButtonCritical:!0,secondaryButtonLabel:this.hass.localize("ui.common.cancel"),cancel:()=>{e(!1)},confirm:()=>{e(!0)}};_t(this,{dialogTag:"generic-dialog",dialogImport:()=>Promise.resolve().then((function(){return oo})),dialogParams:t})})&&ft(this.hass,t.schedule_id).catch(e=>kt(e,this,this.hass))}}_retryConnection(){setTimeout(async()=>{await this.loadSchedules()},100),this.connectionError=!1,this.requestUpdate()}},e.SchedulerCard.styles=r`
    ${La}
    hui-warning {
      padding: 10px 0px;
    }
